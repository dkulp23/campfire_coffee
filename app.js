...
//   ulEl: document.createElement('ul'),
//   retrieveKioskProperty: function(someNewArray, someProperty) {
//     for (var i = 0; i < kioskArray.length; i++) {
//         this.someNewArray.push(kioskArray[i].someProperty);
//     }
//   },
//   totalCustomers: function() {
//     for (var j = 0; j < hoursOfDay.length; j++) {
...
// var companyTotalsCalls = function(location) {
//   location.retrieveKioskProperty(custEachHour, custEachHour);
// };
//
// companyTotalsCalls(campfireCoffee);
